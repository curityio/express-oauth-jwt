    ...
    function tokenHasRequiredClaims(token, expectedClaims) {
        for (let index = 0; index < expectedClaims.length; index++) {
            ...
            if (Array.isArray(claim)) {
                ...
                // For array claims such as 'aud', any matching element passes
                return claim.indexOf(expectedClaim.value) !== -1;

            } else {

                // For individual claims such as 'iss', require an exact match
